from utils.utils import load_data_trunc, normalize_adj, sparse_to_tuple
import scipy.sparse as sp
import numpy as np
import torch
from torch.optim import Adam
import algorithms.vgae.model as m
from sklearn.metrics import roc_auc_score, average_precision_score
import time


def run_vgae(args):
    adj, features, _, _, _, _ = load_data_trunc(args.input)
    ...
    model = getattr(m, args.model)(adj_norm)
