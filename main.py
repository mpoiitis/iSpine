...
def parse_args():
    ...
    kSpace_parser.add_argument("--alpha", default='linear', type=str, choices=['linear', 'exp', 'zeros', 'ones'], help="How to calculate alpha for every training epoch. [linear, exp, zeros, ones]. Default is linear")
    ...
    kSpaceGnn_parser.add_argument('--dims', nargs='+', type=int, default=[200, 100], help='Number of units in hidden layers. Example --dims 500 200. Default is [200, 100].')
