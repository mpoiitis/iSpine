...
def parse_args():
    ...
    kSpaceGnn_parser.add_argument("--repeats", default=1, type=int, help="How many times to repeat the experiment. Default is 1.")
    kSpaceGnn_parser.add_argument('--dims', nargs='+', type=int, default=[200, 100], help='Number of units in hidden layers. Default is [200, 100]. Example --dims 500 200')
    ...
    kSpaceGnn_parser.add_argument("--power", default=8, type=int, help="The upper bound of convolution order to search. Default is 8.")
    kSpaceGnn_parser.add_argument("--a-max", default=5, type=float, help="The upper bound of alpha rate. Default is 5.")
    ...
    kSpaceGnn_parser.add_argument("--alpha", default='linear', type=str, choices=['linear', 'exp', 'zeros'], help="How to calculate alpha for every training epoch. [linear, exp, zeros]. Default is linear")
